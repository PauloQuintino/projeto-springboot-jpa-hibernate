...
import com.pauloquintino.projetojpa.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		// Tudo que for implementado aqui será executado quando a aplicação for
		// executada
		...
		// inserindo os produtos em suas categorias
